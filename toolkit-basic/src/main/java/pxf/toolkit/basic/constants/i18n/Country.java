 ...
 * @date 2020/10/30
 */
public enum Country implements LocaleFindableEnumConstant<Country> {
  /** 国家枚举类，按字母顺序 */
  AFGHANISTAN("93"),
  ALBANIA("355"),
  ALGERA("213"),
  ...
  private static final LocaleConstantHelper LOCALE_CONSTANT_HELPER =
      new LocaleConstantHelper("toolkit/resources/i18n/country");
   ...
   */
  @Nonnull
  private String getName(@Nullable Locale locale) {
    String key = name().replace(DELIMITER_SYMBOL, PROPERTIES_DELIMITER_SYMBOL).toLowerCase();
    return LOCALE_CONSTANT_HELPER.getValidLocaleName(locale, key);
  }
  ...
  @Override
  @Nonnull
  public String getLocaleName(@Nullable Locale locale) {
   ...
   */
  @Nonnull
  public ResourceBundle getResourceBundle(@Nonnull String baseName) {
   ...
   */
  @Nonnull
  public ResourceBundle getResourceBundle(@Nonnull String baseName, @Nonnull Locale locale) {
    return ResourceBundle.getBundle(baseName, locale);
  }
   ...
   */
  @Nonnull
  public String localeNameDisplayName() {
    return getName(null);
  }

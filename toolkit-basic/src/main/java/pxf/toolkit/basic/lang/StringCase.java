 ...
 */
@ThreadSafe
public enum StringCase implements FindableEnumConstant<StringCase> {
  /** 大小写敏感，默认大写 */
   ...
   */
  @Nonnull
  public final String handleStringCase(@Nonnull String str) {
   ...
   * @throws NullPointerException if either string is null
   */
  public final boolean checkEquals(@Nonnull String str1, @Nonnull String str2) {
   ...
   * @throws NullPointerException if either string is null
   */
  public final boolean checkStartsWith(@Nonnull String str, @Nonnull String start) {
   ...
   * @throws NullPointerException if either string is null
   */
  public final boolean checkEndsWith(@Nonnull String str, @Nonnull String end) {
   ...
   * @throws NullPointerException if either string is null
   */
  public final int checkIndexOf(@Nonnull String str, int strStartIndex, String search) {
   ...
   * @throws NullPointerException if either string is null
   */
  public final boolean checkRegionMatches(@Nonnull String str, int strStartIndex, String search) {

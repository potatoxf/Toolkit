...
public class StopWatch implements State {
  ...
  private StopWatch(TimeSupplier timeSupplier) {
   ...
   * @return {@code StopWatch}
   */
  public static StopWatch createStarted(TimeSupplier timeSupplier) {
   ...
   * @return {@code StopWatch}
   */
  public static StopWatch create(TimeSupplier timeSupplier) {
  ...
  public void start() {
    ...
    startTime = timeSupplier.currentTime();
  ...
  public void stop() {
    ...
    if (runningState == RUNNING) {
      stopTime = timeSupplier.currentTime();
    }
  ...
  public void resume() {
    ...
    startTime += timeSupplier.currentTime() - stopTime;
    runningState = RUNNING;
  }
  ...
  public long getTime() {
    if (runningState == STOPPED || runningState == SUSPENDED) {
      ...
      return timeSupplier.currentTime() - startTime;
    }
